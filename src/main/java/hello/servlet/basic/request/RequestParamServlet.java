...
public class RequestParamServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        printAllParameter(request);
        printSingleParameter(request);
        printDupParameter(request);
    }

    //전체 파라미터 조회
    private void printAllParameter(HttpServletRequest request){
    ...
    //중복 이름 파라미터 조회 getParameterValues 이용
    private void printDupParameter(HttpServletRequest request){
